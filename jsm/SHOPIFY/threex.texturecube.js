...
THREEx.TextureCube  = {}
THREEx.TextureCube.baseUrl = "https://cdn.shopify.com/s/files/1/0234/7158/7424/files/";
...
THREEx.TextureCube.initWellKnownUrls = function(baseUrl){
 ...
 wellKnownUrls['Brudslojan']  = THREEx.TextureCube.createUrls('Brudslojan'   , '.jpg', rootUrl),
 wellKnownUrls['skybox']   = THREEx.TextureCube.createUrls('skybox'  , '.jpg', rootUrl),
    //wellKnownUrls['skybox']   = THREEx.TextureCube.createUrls( '.jpg', rootUrl),
 wellKnownUrls['swedishroyalcastle'] = THREEx.TextureCube.createUrls('SwedishRoyalCastle' , '.jpg', rootUrl),
 wellKnownUrls['Meadow']   = THREEx.TextureCube.createUrls('Meadow'   , '.jpg', rootUrl),
    wellKnownUrls['Langholmen2'] = THREEx.TextureCube.createUrls('Langholmen2'   , '.jpg', rootUrl)
